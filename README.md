...
| GeyserModelEngineExtension | [Github](https://github.com/GeyserExtensionists/GeyserModelEngine) | Help you automatically transform the model to generate resource packs        |
...
- Put `GeyserModelEngineExtension` and `geyserutils-geyser` into `plugins/[Geyser-Folder]/extensions`
...
# Convert Models
`GeyserModelEngineExtension` is capable of generating models all by itself. After generating it will also apply this pack automatically.
...
- Go to  `plugins/[Geyser-Folder]/extensions/geysermodelengineextension`, and you should see your pack generated!
